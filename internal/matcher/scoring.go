...
var synonyms = map[string]string{
	...
	"wins": "win", "winning": "win", "won": "win", "winner": "win", "winners": "win", "champion": "win", "champions": "win",
	...
	"competes": "compete", "competing": "compete", "competed": "compete", "competitor": "compete", "competitors": "compete",
	"qualifies": "qualify", "qualifying": "qualify", "qualified": "qualify", "qualifiers": "qualify", "qualifier": "qualify",
	...
	"attacker": "attack", "attackers": "attack", "attacked": "attack", "attacking": "attack",
	"invader": "invade", "invaders": "invade", "invaded": "invade", "invading": "invade",
	...
	"pulls": "pull", "pulling": "pull", "pulled": "pull",
	"removes": "remove", "removing": "remove", "removed": "remove",
	"fires": "fire", "firing": "fire", "fired": "fire",
	"hires": "hire", "hiring": "hire", "hired": "hire",
	"appoints": "appoint", "appointing": "appoint", "appointed": "appoint",
	"scores": "score", "scoring": "score", "scored": "score",
	"assists": "assist", "assisting": "assist", "assisted": "assist",
	...
	"acquires": "acquire", "acquiring": "acquire", "acquired": "acquire",
	"merges": "merge", "merging": "merge", "merged": "merge",
	"endorses": "endorse", "endorsing": "endorse", "endorsed": "endorse",
	"nominates": "nominate", "nominating": "nominate", "nominated": "nominate",
	"vetoes": "veto", "vetoing": "veto", "vetoed": "veto",
	"withdraws": "withdraw", "withdrawing": "withdraw", "withdrew": "withdraw", "withdrawn": "withdraw",
	"deploys": "deploy", "deploying": "deploy", "deployed": "deploy",
	"meets": "meet", "meeting": "meet", "met": "meet",
	"visits": "visit", "visiting": "visit", "visited": "visit",
	"says": "say", "saying": "say", "said": "say",
	"posts": "post", "posting": "post", "posted": "post",
	"tweets": "tweet", "tweeting": "tweet", "tweeted": "tweet",
	"pardons": "pardon", "pardoning": "pardon", "pardoned": "pardon",
	"convicts": "convict", "convicting": "convict", "convicted": "convict",
	"indicts": "indict", "indicting": "indict", "indicted": "indict",
	"arrests": "arrest", "arresting": "arrest", "arrested": "arrest",
	"sanctions": "sanction", "sanctioning": "sanction", "sanctioned": "sanction",
	"recognizes": "recognize", "recognizing": "recognize", "recognized": "recognize",
	"nationalizes": "nationalize", "nationalizing": "nationalize", "nationalized": "nationalize",
